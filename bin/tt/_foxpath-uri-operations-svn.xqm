...
(: 
 ...
 :)
 declare function f:fox-file-exists_svn($uri as xs:string, $options as map(*)?)
        as xs:boolean? {    
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-is-file_svn($uri as xs:string, $options as map(*)?)
        as xs:boolean? {    
    let $useUri := substring($uri, 5)
    let $list :=
        try {
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-is-dir_svn($uri as xs:string, $options as map(*)?)
        as xs:boolean? {    
    let $useUri := substring($uri, 5)
    let $list :=
        try {
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-file-size_svn($uri as xs:string, $options as map(*)?)
        as xs:integer? {    
    let $useUri := substring($uri, 5)
    let $list :=
        try {
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-file-date_svn($uri as xs:string, $options as map(*)?)
        as xs:dateTime? {    
    let $useUri := substring($uri, 5)
    let $list :=
        try {
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-doc_svn($uri as xs:string, $options as map(*)?)
        as document-node()? {    
    let $useUri := substring($uri, 5)
    return
        try {
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-doc-available_svn($uri as xs:string, $options as map(*)?)
        as xs:boolean {    
    let $useUri := substring($uri, 5)
    return
        exists(
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-unparsed-text_svn($uri as xs:string,
...
(:~
 ...
 : @return true if the resource exists and is a file
 :)
 declare function f:fox-unparsed-text-lines_svn($uri as xs:string,
                                                $encoding as xs:string?, 
                                                $options as map(*)?)
        as xs:string* {    
    let $useUri := substring($uri, 5)
