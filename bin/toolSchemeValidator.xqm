(: toolSchemeValidator.xqm - parses a directory and constructs a tool scheme
 :
 : @version 20140826-1
 :
 : Rules:
...
declare variable $f:predefinedTypesDict :=
    <types>
        ...
        <type name="file" reqFeature="file"/>        
    </types>;

declare variable $f:systemFacetsDict := 
    <facets>
        <facet name="minDocCount" typeClasses="" facetValueConstraint=""/>    
        <facet name="maxDocCount" typeClasses="" facetValueConstraint=""/>        
        <facet name="docCount" typeClasses="" facetValueConstraint=""/>        
